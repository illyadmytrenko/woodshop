  ...
  switch (action.type) {
    ...
    case ProductsActionType.GET_ALL_PRODUCTS_SUCCESS:
      return {
        ...
        products: (<ProductAction>action).payload._embedded.products,
        pageInfo: (<ProductAction>action).payload.page,
    ...
    case ProductsActionType.GET_ALL_PRODUCTS_ERROR:
      return {
        ...
        errorMessage: (<ProductAction>action).payload,
      };
    ...
    //   return {
    //     ...state,
    //     searchCriteria: (<ProductAction>action).payload,
    //   };
